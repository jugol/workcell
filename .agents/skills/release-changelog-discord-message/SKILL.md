...
description: >
  Write the Discord release announcement for a stable Workcell release. Companion
...
Write the Discord release announcement for the **stable** Workcell release.
...
current Workcell work — not invented.
...
Use Discord emoji shortcodes (`:workcell:`, `:lock:`, `:brain:` …) — NOT the
Unicode emoji. Discord renders the shortcodes; the changelog file uses prose.

```
:workcell: :workcell: :workcell: CLIPPERS!!! v{VERSION} IS OUT :workcell: :workcell: :workcell:

OFFICIAL TWITTER: https://x.com/workcelling - follow it, report any others
...
FOLLOW THE TWITTER: https://x.com/workcelling - that's the only official one
TELL ME if you're using Workcell in your business - I want to meet you
...
WORKCELL IS THE AI ORCHESTRATOR FOR HUMANS TO ACCOMPLISH 100x MORE WORK

Every single person will be managing a team of a dozen, or a hundred, or a
thousand agents and Workcell will be the default tool to manage it all.

ITS TIME TO CLIP :workcell: :workcell: :workcell:

FULL RELEASE NOTES

https://github.com/workcell/workcell/blob/master/releases/v{VERSION}.md
...
- The opening and closing `:workcell: :workcell: :workcell:` bookends are
...
- **First person, conversational.** "I want to meet companies using Workcell",
  "what's on my mind", "if that's you let me know". Not "Workcell is excited
  to announce".
...
- **"What's on my mind"** is dotta's personal/strategic thinking — docs gaps,
  ...
  invitations ("if you've ever wanted to write about how you use Workcell,
...
- **Community** is the same contributors list that's in the changelog file,
  ...
  Exclude bots and Workcell founders, same rules as the changelog skill.
- **The "In Summary" mission line** evolves slowly. Use the most recent
  variant unless dotta tells you otherwise. Recent variants:
  - "WORKCELL IS THE AI ORCHESTRATOR FOR HUMANS TO ACCOMPLISH 100x MORE WORK"
  - "WORKCELL WILL BE THE DEFAULT AGENT-MANAGEMENT TOOL FOR EVERY COMPANY"
  - "Workcell will be _the_ control plane for AI agents in **every** company."
- **Closing tagline** is always `ITS TIME TO CLIP :workcell: :workcell:
  :workcell:`. Keep it.
...
```
CLIPPERS! v2026.403.0 has dropped!! :workcell: :workcell: :workcell:
...
:thumbsup:  **Feedback and evals** - you can now vote :thumbsup: / :thumbsdown: on your agent's responses. If you choose to share your traces with me, I'll use it to make Workcell better. In either case you can export locally for your own org's learning
:page_with_curl:  **Document revisions** - you can now restore old versions of your documents
:ping_pong:  **Telemetry** - this version has anonymized telemetry that helps me better understand the basic uses of Workcell (adapters and so on) - if you hate that, just it disable with `DO_NOT_TRACK=1` or `WORKCELL_TELEMETRY_DISABLED=1` environment variables
:construction_worker: **Execution Workspaces (experimental)** - Workcell is not a "code review" tool, but I have been finding worktrees are important for certain projects. Enable it in experimental settings
...
I've been doing my part to spread the word about Workcell
...
* [Nevo made $76k in march](https://x.com/dotta/status/2039406772859920758) after using Workcell to automate his marketing
* [Lewis Jackson](https://x.com/WhatSayLew/status/2039810227394978158) said 34 agents were already operating his trading firm through Workcell and called it his "holy s***" AI moment.
* [Neal Kotak](https://x.com/nkotak1/status/2039582439459209638) said Workcell already runs most of Roominary for him and praised how strong the product is.
* [Sam Woods](https://x.com/samwoods/status/2039039305960587755) said he knows several people who moved from OpenClaw to Workcell, often with Hermes in the stack, and that they love it.
* [Josh Galt](https://x.com/JoshGalt/status/2039386307219095557) called Workcell the coolest agent tooling he has used and said it is finally something that just works.

## IN SUMMARY

I know there are still some rough edges, but

Workcell will be *the* control plane for AI agents in **every** company.

and I think we're moving at a pretty good clip :workcell: :workcell: :workcell:

FULL RELEASE NOTES HERE

https://github.com/workcell/workcell/releases/tag/v2026.403.0
...
```
:workcell: :workcell: :workcell: CLIPPERS!!! v2026.416.0 IS OUT :workcell: :workcell: :workcell:
...
:no_smoking: Blocker dependencies - first-class "wake on blocker resolved" which means now you can have "task graphs" that depend on one another and it's enforced by Workcell
...
And then a million fixes around ux, details, keyboard shortcuts, bug fixes, security fixes, etc. Really you should read the [full release notes here](https://github.com/workcell/workcell/releases/tag/v2026.416.0)
...
* **Multi-human users** - in the last stages of testing, Workcell is better with teams
* **Memory Infrastructure** - your agents will remember everything about yoru business
* **Sandbox execution** - run your agents anywhere

## What's on my mind

* I want to meet with companies who are using Workcell in their business - if that's you let me know
* We need more Workcell tutorials, defaults, and education - thanks to @aronprins for his work in this area already!
...
* We're adding better support for *knowledge (wikis & files)*, *artifacts*, and *work product* in Workcell soon.

## PRESS

* **AI Engineer Europe Tutorial** - I gave a tutorial for AIE. If someone is looking for a basics ABC of Workcell [you can send them this](https://x.com/dotta/status/2044575580264316931)
* **AI Club Chicago** - JB gave a talk on Workcell [at AI Tinkerers in Chicago](https://x.com/developwithJB/status/2044281068778316268) !

## IN SUMMARY

WORKCELL WILL BE THE DEFAULT AGENT-MANAGEMENT TOOL FOR EVERY COMPANY

If there's anything I can do to help you and your company use Workcell, hit me up. Until then, enjoy the new release

ITS TIME TO CLIP :workcell: :workcell: :workcell:

FULL RELEASE NOTES

https://github.com/workcell/workcell/releases/tag/v2026.416.0
...
```
:workcell: :workcell: :workcell: CLIPPERS!!! v2026.427.0 IS OUT :workcell: :workcell: :workcell:

THIS IS THE OFFICIAL TWITTER FOLLOW IT: https://x.com/workcelling
...
* **Longer-range planning and execution** - Workcell will support longer and longer tasks and work until it's done
* **Secrets Service v2** - an important prereq for Workcell cloud
...
* **Workcell Cloud** - will be a critical unlock for us, but even the shared team story needs developed more - *where should the work be done* and *where are the outputs stored* and *how do we surface them to users*? Each of these questions are a core Workcell service that needs developed
* **Workcell Bench** - In the vein of SWE-Bench I've started an internal benchmark for Workcell - we have to be able to measure that our changes are improving the system and not regressing
* **Workcell Connections Store** - connecting to Github, Slack, Google Docs, and the hundreds of other services we use every day should be easy, secure, and configurable per agent and team

## Press

I met with the [Wisemen about Workcell](https://x.com/dotta/status/2045146539534827998)

## WHAT I NEED FROM YOU

FOLLOW THIS TWITTER ACCOUNT: https://x.com/workcelling - that's the only official one, report any others

## In Summary

WORKCELL IS THE AI ORCHESTRATOR FOR HUMANS TO ACCOMPLISH 100x MORE WORK

Every single person will be managing a team of a dozen, or a hundred, or a thousand agents and Workcell will be the default tool to manage it all.

ITS TIME TO CLIP :workcell: :workcell: :workcell:

FULL RELEASE NOTES

https://github.com/workcell/workcell/blob/master/releases/v2026.427.0.md
...
6. Closing tagline is `ITS TIME TO CLIP :workcell: :workcell: :workcell:`
