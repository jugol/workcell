...
description: >
  Generate the stable Workcell release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** Workcell release.

## Versioning Model

Workcell uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/workcell/workcell/pull/123), @contributor1, @contributor2)
```
...
Exclude Workcell founders from the list (e.g. `cryppadotta`, `forgottendev`, `devinfoley`, `sockmonster`, `scotttong`)
