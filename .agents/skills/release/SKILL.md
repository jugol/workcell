...
name: release
description: >
  Coordinate a full Workcell release across engineering verification, npm,
...
Run the full Workcell maintainer release workflow, not just an npm publish.
...
7. If running through Workcell, you have issue context for status updates and follow-up task creation.
...
Workcell now uses a commit-driven release model:
...
npm view workcell@canary version
```
...
- release summary in Workcell issue context
