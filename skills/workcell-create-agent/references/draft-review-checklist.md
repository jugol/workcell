...
- [ ] The first paragraph points at the Workcell skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Workcell execution contract verbatim:
...
- [ ] Adapter config matches this Workcell instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
