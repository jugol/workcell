...
One or two sentences. Name the agent, its role, and its company. State the reporting line. Point at the Workcell heartbeat skill as the source of truth for the wake procedure.
