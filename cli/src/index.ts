...
import { registerBootstrapCommands } from "./commands/client/bootstrap.js";
import { registerCodeGraphCommands } from "./commands/client/code-graph.js";
import { registerIssueCommands } from "./commands/client/issue.js";
import { registerDesignCommands } from "./commands/client/design.js";
...
const DATA_DIR_OPTION_HELP =
  "Workcell data directory root (isolates state from ~/.workcell)";

program
  .name("workcell")
  .description("Workcell CLI — setup, diagnose, and configure your instance")
  .version(cliVersion);
...
program.hook("preAction", (_thisCommand, actionCommand) => {
  ...
  loadWorkcellEnvFile(options.config);
...
program
  ...
  .option("--run", "Start Workcell immediately after saving config", false)
  .action(onboard);

program
  .command("doctor")
  .description("Run diagnostic checks on your Workcell setup")
  .option("-c, --config <path>", "Path to config file")
  .option("-d, --data-dir <path>", DATA_DIR_OPTION_HELP)
...
program
  ...
  .option("--filename-prefix <prefix>", "Backup filename prefix", "workcell")
...
program
  .command("run")
  .description("Bootstrap local setup (onboard + doctor) and run Workcell")
  .option("-c, --config <path>", "Path to config file")
  .option("-d, --data-dir <path>", DATA_DIR_OPTION_HELP)
...
heartbeat
  ...
  .option("--api-base <url>", "Base URL for the Workcell server API")
...
registerCodeGraphCommands(program);
