...
const STORIES = [
  {
    id: "workcell-source-issue-recovery--recovery-action-card-states",
    label: "card-states",
  },
  {
    id: "workcell-source-issue-recovery--inbox-row-chips",
    label: "inbox-rows",
  },
  {
    id: "workcell-source-issue-recovery--blocker-notice-recovery-indicators",
    label: "blocker-notice",
  },
  {
    id: "workcell-source-issue-recovery--active-run-panel-recovery-chips",
