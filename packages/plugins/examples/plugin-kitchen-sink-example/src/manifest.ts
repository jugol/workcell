...
const manifest: WorkcellPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Workcell plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Workcell",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Workcell domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
