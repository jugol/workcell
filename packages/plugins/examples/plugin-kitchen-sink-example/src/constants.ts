import type { PluginLauncherRegistration } from "@workcell/plugin-sdk";

export const PLUGIN_ID = "workcell-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".workcell-kitchen-sink-demo.txt",
} as const;
