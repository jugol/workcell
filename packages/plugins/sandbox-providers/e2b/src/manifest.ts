...
const PLUGIN_ID = "workcell.e2b-sandbox-provider";
...
const manifest: WorkcellPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions E2B cloud sandboxes as Workcell execution environments.",
  author: "Workcell",
      ...
      configSchema: {
        ...
        properties: {
          ...
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific E2B API key. Paste a key or an existing Workcell secret reference; saved environments store pasted values as company secrets. Falls back to E2B_API_KEY if omitted.",
          },
          timeoutMs: {
            type: "number",
            description:
