...
const PLUGIN_ID = "workcell.modal-sandbox-provider";
...
const manifest: WorkcellPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions Modal sandboxes as Workcell execution environments.",
  author: "Workcell",
      ...
      configSchema: {
        ...
        properties: {
          ...
          tokenId: {
            ...
            format: "secret-ref",
            description:
              "Modal token ID. Paste a token or an existing Workcell secret reference; saved environments store pasted values as company secrets. Required.",
          },
          tokenSecret: {
            type: "string",
            format: "secret-ref",
