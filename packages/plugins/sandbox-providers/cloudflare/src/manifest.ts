...
const PLUGIN_ID = "workcell.cloudflare-sandbox-provider";
  ...
  environmentDrivers: [
    {
      ...
      description:
        "Runs Workcell sandbox environments through a Cloudflare Worker bridge backed by the Sandbox SDK and Durable Objects.",
      configSchema: {
        type: "object",
        properties: {
          bridgeBaseUrl: {
