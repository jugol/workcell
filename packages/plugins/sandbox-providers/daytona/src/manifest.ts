...
const PLUGIN_ID = "workcell.daytona-sandbox-provider";
...
const manifest: WorkcellPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions Daytona sandboxes as Workcell execution environments.",
  author: "Workcell",
      ...
      configSchema: {
        ...
        properties: {
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific Daytona API key. Paste a key or an existing Workcell secret reference; saved environments store pasted values as company secrets. Falls back to DAYTONA_API_KEY if omitted.",
          },
          apiUrl: {
            type: "string",
            description:
