...
const PLUGIN_ID = "workcell.fake-sandbox-provider";
...
const manifest: WorkcellPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Workcell provider-plugin integration without external infrastructure.",
  author: "Workcell",
