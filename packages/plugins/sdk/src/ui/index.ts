/**
 * `@workcell/plugin-sdk/ui` — Workcell plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@workcell/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@workcell/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate Workcell-internal links through the host router
