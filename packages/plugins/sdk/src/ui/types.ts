/**
 * Workcell plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@workcell/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed Workcell navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a Workcell-internal path using the active company prefix.
   *
