/**
 * `definePlugin` — the top-level helper for authoring a Workcell plugin.
 *
...
// ---------------------------------------------------------------------------
// WorkcellPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface WorkcellPlugin {
 ...
 * @returns A sealed `WorkcellPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@workcell/plugin-sdk";
