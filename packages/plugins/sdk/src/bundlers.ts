/**
 * Bundling presets for Workcell plugins.
 *
 ...
 * to match the Workcell plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@workcell/plugin-sdk/ui",
    "@workcell/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
