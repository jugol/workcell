...
3. **Return a triage list**, grouped by severity:
   ...
   Each item has: file path, evidence (a 1–2 line quote), suggested fix, and the operation that should follow up (`ingest`, `workcell-distill`, `index-refresh`, manual review).
