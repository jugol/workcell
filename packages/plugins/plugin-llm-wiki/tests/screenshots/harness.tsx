...
const MANAGED_AGENT = {
  ...
  resourceKey: "workcell.plugin-llm-wiki:agent:wiki-maintainer",
...
const MANAGED_PROJECT = {
  ...
  resourceKey: "workcell.plugin-llm-wiki:project:llm-wiki",
...
const MANAGED_ROUTINE = {
  ...
  resourceKey: "workcell.plugin-llm-wiki:routine:nightly-wiki-lint",
  routine: {
    id: "rtn-llmw-night",
...
const MANAGED_ROUTINES = [
  {
    ...
    resourceKey: "workcell.plugin-llm-wiki:routine:cursor-window-processing",
    routine: {
      id: "rtn-llmw-cursor",
  ...
  MANAGED_ROUTINE,
  {
    ...
    resourceKey: "workcell.plugin-llm-wiki:routine:index-refresh",
    routine: {
      id: "rtn-llmw-index",
...
const MANAGED_SKILL = {
  ...
  details: {
    ...
    key: "plugin/workcell-plugin-llm-wiki/wiki-maintainer",
    description: "Use the LLM Wiki plugin tools to maintain a cited local company wiki.",
  },
};
const MANAGED_SKILLS = [
  MANAGED_SKILL,
  { status: "resolved", skillId: "skl-llmw-ingest", resourceKey: "wiki-ingest", details: { name: "Wiki Ingest", key: "plugin/workcell-plugin-llm-wiki/wiki-ingest", description: null } },
  { status: "resolved", skillId: "skl-llmw-query", resourceKey: "wiki-query", details: { name: "Wiki Query", key: "plugin/workcell-plugin-llm-wiki/wiki-query", description: null } },
  { status: "resolved", skillId: "skl-llmw-lint", resourceKey: "wiki-lint", details: { name: "Wiki Lint", key: "plugin/workcell-plugin-llm-wiki/wiki-lint", description: null } },
  { status: "resolved", skillId: "skl-llmw-distill", resourceKey: "workcell-distill", details: { name: "Workcell Distill", key: "plugin/workcell-plugin-llm-wiki/workcell-distill", description: null } },
  { status: "resolved", skillId: "skl-llmw-index", resourceKey: "index-refresh", details: { name: "Index Refresh", key: "plugin/workcell-plugin-llm-wiki/index-refresh", description: null } },
];
...
const PAGES = {
  ...
  sources: [
    ...
    { rawPath: "raw/workcell-v1-spec.md", title: "Workcell V1 spec", sourceType: "file", url: null, status: "captured", createdAt: "2026-05-01T18:30:00Z" },
...
A **plugin-managed resource** is a normal Workcell resource (agent, routine, project) that a plugin has seeded with suggested defaults. The plugin marks ownership via a stable \`resourceKey\` so that installs, imports, and upgrades can find the resource even when UUIDs differ.
...
`,
  ...
  sourceRefs: ["raw/karpathy-llm-wiki.md", "raw/workcell-v1-spec.md"],
...
const OPERATIONS = {
  operations: [
    ...
    { id: "2939ffffffff", operationType: "ingest", status: "done", hiddenIssueId: "ii-2939", hiddenIssueIdentifier: "PAP-OP-2939", hiddenIssueTitle: "workcell-v1-spec.md · 3 pages created", hiddenIssueStatus: "done", projectId: "prj-llmw-7e1a", costCents: 2, warnings: [], affectedPages: [{ path: "wiki/areas/control-plane.md" }, { path: "wiki/concepts/managed-resources.md" }, { path: "wiki/concepts/origin-kind.md" }], createdAt: "2026-05-01T18:30:00Z", updatedAt: "2026-05-01T18:32:00Z" },
...
You maintain this wiki through Workcell plugin tools.
...
(globalThis as { __workcellPluginBridge__?: { sdkUi?: Record<string, unknown> } }).__workcellPluginBridge__ = { sdkUi };
