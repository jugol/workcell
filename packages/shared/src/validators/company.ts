...
export const createCompanySchema = z.object({
  ...
  // Design-first at the door: onboarding offers "design system as source of
  // truth" as the default for new development teams. Optional so API callers
  // and existing flows keep the column default (off).
...
export const updateCompanySchema = createCompanySchema
  ...
  .extend({
    ...
    requireDesignFirst: z.boolean().optional(),
    // Team autonomy settings — per-step autonomy/intervention switches.
    autoApproveConfirmations: z.boolean().optional(),
    autoRouteNewIssues: z.boolean().optional(),
    pairAutoRunDefault: z.boolean().optional(),
