...
export interface InstanceExperimentalSettings {
  ...
  /**
   * Autonomous (unattended) mode — skip user-participation gates so the workflow
   * runs without a human in the loop (user execution-policy stages auto-approve;
   * new agent hires bypass board approval). Agent QA/compound stages and budget
   * safety gates are unaffected.
   */
