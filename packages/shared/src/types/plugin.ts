...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within WorkcellPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Declares a normal Workcell agent that a plugin can provision and later
...
export interface PluginManagedAgentDeclaration {
  ...
  /** Suggested Workcell runtime configuration. */
...
/**
 * Declares a normal Workcell project that a plugin can provision and later
 * resolve by stable key within each company.
 */
...
/**
 * Lower-bound semver requirement for the Workcell host.
 *
...
export interface WorkcellPluginManifestV1 {
   ...
   */
  minimumWorkcellVersion?: PluginMinimumHostVersion;
