CREATE TABLE IF NOT EXISTS "feedback_exports" (
	...
	"schema_version" text DEFAULT 'workcell-feedback-envelope-v2' NOT NULL,
	"bundle_version" text DEFAULT 'workcell-feedback-bundle-v2' NOT NULL,
	"payload_version" text DEFAULT 'workcell-feedback-v1' NOT NULL,
	"payload_digest" text,
