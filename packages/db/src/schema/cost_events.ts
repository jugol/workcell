...
export const costEvents = pgTable(
  "cost_events",
  {
    ...
    // WC-137: agentId is nullable + ON DELETE SET NULL so a company's billing
    // history survives agent hard-delete (company spend totals must not shrink
    // when an agent is removed — companyId is preserved). Matches the
    // billing-preservation discipline of issue/project/goal removal (WC-134/135).
