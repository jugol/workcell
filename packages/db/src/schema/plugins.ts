...
import type { PluginCategory, PluginStatus, WorkcellPluginManifestV1 } from "@workcell/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<WorkcellPluginManifestV1>().notNull(),
