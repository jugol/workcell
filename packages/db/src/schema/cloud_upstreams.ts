...
export const cloudUpstreamRuns = pgTable(
  "cloud_upstream_runs",
  {
    ...
    summary: jsonb("summary").$type<import("@workcell/shared").CloudUpstreamSummaryCount[]>().notNull().default([]),
    warnings: jsonb("warnings").$type<import("@workcell/shared").CloudUpstreamWarning[]>().notNull().default([]),
    conflicts: jsonb("conflicts").$type<import("@workcell/shared").CloudUpstreamConflict[]>().notNull().default([]),
    events: jsonb("events").$type<import("@workcell/shared").CloudUpstreamRunEvent[]>().notNull().default([]),
