...
// @google/gemini-cli. The bootstrap also sets WORKCELL_NPM_BOOTSTRAPPED=1
...
export function buildSandboxNpmInstallCommand(packageName: string): string {
  ...
  return [
    ENSURE_NPM_PREAMBLE,
    'if [ -n "$WORKCELL_NPM_BOOTSTRAPPED" ]; then',
