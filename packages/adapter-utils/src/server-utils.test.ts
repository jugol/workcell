  ...
  it("adds shared workspace env vars including AGENT_HOME", () => {
    const env = applyWorkcellWorkspaceEnv(
      {},
      {
        ...
        workspaceRepoUrl: "https://github.com/workcell/workcell.git",
    ...
    expect(env).toEqual({
      ...
      WORKCELL_WORKSPACE_REPO_URL: "https://github.com/workcell/workcell.git",
      ...
      workspaceHints: [
        {
          workspaceId: "workspace-1",
          cwd: "/tmp/workspace",
          repoUrl: "https://github.com/workcell/workcell.git",
        },
        {
