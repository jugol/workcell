...
// WC-67: outbound MCP-server injection helpers (.mcp.json for agent CLIs).
// Pure + browser-safe (no `process`/Node imports).
export {
  extractMcpServersFromConfig,
  buildWorkcellMcpServerSpec,
  buildMcpJsonConfig,
  buildCodexMcpToml,
  codexMcpServerTableKey,
