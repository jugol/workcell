...
import * as serverUtils from "@workcell/adapter-utils/server-utils";
export type { RunProcessResult } from "@workcell/adapter-utils/server-utils";
...
export const buildWorkcellEnv = serverUtils.buildWorkcellEnv;
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "WORKCELL_RESOLVED_COMMAND"] =
