...
import { pluginManifestV1Schema, type WorkcellPluginManifestV1 } from "@workcell/shared";
...
function manifest(apiRoutes: NonNullable<WorkcellPluginManifestV1["apiRoutes"]>): WorkcellPluginManifestV1 {
  return {
    id: "workcell.scoped-api-test",
    apiVersion: 1,
    version: "1.0.0",
