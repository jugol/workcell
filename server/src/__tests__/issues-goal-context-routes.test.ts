...
// The heartbeat-context route projects the REAL deriveIssueDesignGate over the
// work products. Mocking ../services/index.js would otherwise drop that export;
// load the real implementation (its module is not mocked) for the factory.
...
describe.sequential("issue goal context routes", () => {
  beforeEach(() => {
    ...
    // Reset the work-products default each test so a per-test mockResolvedValue
