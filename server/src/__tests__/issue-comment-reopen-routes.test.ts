...
const mockInstanceSettingsService = vi.hoisted(() => ({
  ...
  // The PATCH /issues/:id handler reads getExperimental().autonomousMode when a
  // staged execution policy with a user-participation stage is in play (WC-168).
...
describe.sequential("issue comment reopen routes", () => {
  beforeEach(() => {
    ...
    mockInstanceSettingsService.getExperimental.mockResolvedValue({ autonomousMode: false });
