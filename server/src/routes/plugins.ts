...
import type { PluginPerformActionActorContext, ToolRunContext } from "@workcell/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@workcell/plugin-sdk";
import {
  assertAuthenticated,
  assertBoard,
...
type PluginUiSlotDeclaration = NonNullable<NonNullable<WorkcellPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<WorkcellPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @workcell/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@workcell/plugin-workspace-diff",
    pluginKey: "workcell.workspace-diff",
  ...
  {
    packageName: "@workcell/plugin-hello-world-example",
    pluginKey: "workcell.hello-world-example",
    displayName: "Hello World Widget (Example)",
    description: "Reference UI plugin that adds a simple Hello World widget to the Workcell dashboard.",
    localPath: "packages/plugins/examples/plugin-hello-world-example",
    tag: "example",
  },
  {
    packageName: "@workcell/plugin-file-browser-example",
    pluginKey: "workcell-file-browser-example",
  ...
  {
    packageName: "@workcell/plugin-kitchen-sink-example",
    pluginKey: "workcell-kitchen-sink-example",
    displayName: "Kitchen Sink (Example)",
    description: "Reference plugin that demonstrates the current Workcell plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
    localPath: "packages/plugins/examples/plugin-kitchen-sink-example",
    tag: "example",
  },
  {
    packageName: "@workcell/plugin-orchestration-smoke-example",
    pluginKey: "workcell.plugin-orchestration-smoke-example",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "workcell.claude-usage",
