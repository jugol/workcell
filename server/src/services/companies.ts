...
export function companyService(db: Db) {
  ...
  const companySelection = {
    ...
    autoApproveConfirmations: companies.autoApproveConfirmations,
    autoRouteNewIssues: companies.autoRouteNewIssues,
    pairAutoRunDefault: companies.pairAutoRunDefault,
