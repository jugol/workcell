...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@workcell/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: WorkcellPluginManifestV1, pluginDbId?: string): void;
