 ...
 */
import type { CompanyPortabilityManifest } from "@workcell/shared";
...
const ROLE_LABELS: Record<string, string> = {
  ...
  // so portability rendering keeps faithful labels for them.
  ceo: "CEO",
  cto: "CTO",
  cmo: "CMO",
  cfo: "CFO",
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Workcell](https://workcell.ing)");
  lines.push("");
