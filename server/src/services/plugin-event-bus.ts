/**
 * PluginEventBus — typed in-process event bus for the Workcell plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@workcell/shared";
import type { PluginEvent, EventFilter } from "@workcell/plugin-sdk";
