import type { Environment, EnvironmentProbeResult } from "@workcell/shared";
import type { Db } from "@workcell/db";
import { ensureSshWorkspaceReady } from "@workcell/adapter-utils/ssh";
import {
...
export async function probeEnvironment(
  ...
  if (parsed.driver === "local") {
    return {
      ok: true,
      driver: "local",
      summary: "Local environment is available on this Workcell host.",
      details: {
