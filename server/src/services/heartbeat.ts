...
// only the deliberation path). 30 min comfortably exceeds a healthy run while
// still bounding a hung one. An explicit non-zero agent timeout is always
// preserved — this default ONLY fills in the unset/0 case.
const DEFAULT_RUN_TIMEOUT_SEC = 1800;
