  ...
  return {
    ...
    create: async (
      ...
      input: {
        ...
        value?: string | null;
        key?: string | null;
        managedMode?: "workcell_managed" | "external_reference";
        description?: string | null;
      ...
      const managedMode = input.managedMode ?? "workcell_managed";
      ...
      if (managedMode === "workcell_managed" && input.externalRef?.trim()) {
        throw unprocessable("Managed secrets cannot override externalRef");
      }
      if (managedMode === "workcell_managed" && !input.value?.trim()) {
      ...
      try {
        ...
        if (managedMode === "workcell_managed") {
    ...
    update: async (
      ...
      if (deleting && secret.managedMode === "workcell_managed") {
      ...
      if (
        secret.managedMode === "workcell_managed" &&
        patch.providerConfigId !== undefined &&
        patch.providerConfigId !== secret.providerConfigId
      ) {
        throw unprocessable(
