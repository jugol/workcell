...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@workcell/shared";
import type {
...
import { createIssue } from "../fixtures/workcellData";
    ...
    <div className="workcell-story">
      <main className="workcell-story__inner space-y-6">
        <section className="workcell-story__frame p-6">
          <div className="workcell-story__label">Language</div>
