...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@workcell/shared";
...
import { createIssue, storybookAgents } from "../fixtures/workcellData";
...
function Section({
  ...
  return (
    <section className="workcell-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="workcell-story__label">{eyebrow}</div>
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="workcell-story">
      <main className="workcell-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
See [the implementation notes](https://github.com/workcell/workcell).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Workcell secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @workcell/ui typecheck", "pnpm build-storybook"],
...
const routineVariables: RoutineVariable[] = [
  {
    ...
    label: "Repository",
    type: "text",
    defaultValue: "workcell/workcell",
    required: true,
    options: [],
  },
  {
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Workcell" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    repoUrl: "https://github.com/workcell/workcell",
    repoRef: "master",
    defaultRef: "master",
    repoName: "workcell",
    localFolder: "/Users/dotta/workcell",
    managedFolder: "workcell",
    effectiveLocalFolder: "/Users/dotta/workcell",
    origin: "local_folder",
  },
  workspaces: [],
...
function FormsEditorsShowcase() {
  return (
    <StoryShell>
      <section className="workcell-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="workcell-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Workcell form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Workcell form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
