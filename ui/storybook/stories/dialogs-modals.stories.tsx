...
import {
  ...
  storybookIssues,
  storybookProjects,
} from "../fixtures/workcellData";

const COMPANY_ID = "company-storybook";
const SELECTED_COMPANY_STORAGE_KEY = "workcell.selectedCompanyId";
const ISSUE_DRAFT_STORAGE_KEY = "workcell:issue-draft";

const storybookGoals: Goal[] = [
  {
    id: "goal-company",
    companyId: COMPANY_ID,
    title: "Build Workcell",
...
const closeReadinessReady: ExecutionWorkspaceCloseReadiness = {
  ...
  plannedActions: [
    ...
    },
    {
      ...
      command: "git worktree remove .workcell/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
    },
    {
      kind: "archive_record",
  ...
  git: {
    repoRoot: "/Users/dotta/workcell",
    workspacePath: "/Users/dotta/workcell/.workcell/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
...
function ProjectDialogOpener({ populated }: { populated?: boolean }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      fillFirstField("input[placeholder='https://github.com/org/repo']", "https://github.com/workcell/workcell");
      fillFirstField("input[placeholder='/absolute/path/to/workspace']", "/Users/dotta/workcell/ui");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Open-state stories for Workcell creation dialogs, workspace confirmations, document diffing, image attachments, and path helper modals.",
      },
    },
  },
} satisfies Meta;
