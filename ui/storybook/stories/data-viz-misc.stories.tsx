...
import type { HeartbeatRun, Issue } from "@workcell/shared";
...
function CompanyPatternIconMatrix() {
  const companies = [
    { name: "Workcell Storybook", color: "#0f766e" },
...
function AsciiArtAnimationDemo({ loading = false }: { loading?: boolean }) {
  return (
    <StoryShell>
      <Section eyebrow="AsciiArtAnimation" title={loading ? "Loading art surface" : "Animated ASCII workcell field"}>
