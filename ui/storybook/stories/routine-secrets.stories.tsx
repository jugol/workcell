...
import { storybookCompanies, storybookSecrets } from "../fixtures/workcellData";

const COMPANY_ID = "company-storybook";

if (typeof window !== "undefined") {
  window.localStorage.setItem("workcell.selectedCompanyId", COMPANY_ID);
}
    ...
    <Card className="w-full max-w-2xl">
      ...
      <CardContent className="space-y-3">
        <p className="text-xs text-muted-foreground">
          ...
          project and agent env. <span className="font-mono">WORKCELL_*</span> variables are reserved.
        </p>
        <EnvVarEditor
          value={env}
