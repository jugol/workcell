...
import type { CompanySearchResult, CompanySearchResponse } from "@workcell/shared";
...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/workcellData";
...
function SearchStories() {
  return (
    <div className="workcell-story">
      <main className="workcell-story__inner max-w-[1320px] space-y-6">
        <section className="workcell-story__frame p-6">
          <div className="workcell-story__label">Search</div>
        ...
        <section className="workcell-story__frame overflow-hidden">
          <div className="workcell-story__title-block">
            <div className="workcell-story__label">/search</div>
        ...
        <section className="workcell-story__frame overflow-hidden p-4">
          <div className="workcell-story__title-block">
            <div className="workcell-story__label">Match-source chips</div>
        ...
        <section className="workcell-story__frame overflow-hidden p-4">
          <div className="workcell-story__title-block">
            <div className="workcell-story__label">Cmd+K palette</div>
        ...
        <section className="workcell-story__frame overflow-hidden p-4">
          <div className="workcell-story__title-block">
            <div className="workcell-story__label">Search result row</div>
