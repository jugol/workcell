...
import type { Goal, Project } from "@workcell/shared";
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-border bg-background p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="workcell-story__label">Goal detail composition</div>
...
function GoalTreeMatrix() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="rounded-lg border border-border bg-background p-4">
        <div className="workcell-story__label">Selected goal</div>
        {selectedGoal ? (
...
function WorktreeBannerMatrix() {
  setWorktreeMeta("workcell-worktree-enabled", "true");
  setWorktreeMeta("workcell-worktree-name", "PAP-1675-projects-goals-workspaces");
  setWorktreeMeta("workcell-worktree-color", "#0f766e");
  setWorktreeMeta("workcell-worktree-text-color", "#ecfeff");
        ...
        <main className="workcell-story__inner space-y-6">
          <section className="workcell-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="workcell-story__label">Projects, goals, and workspaces</div>
