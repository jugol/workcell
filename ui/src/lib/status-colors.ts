...
export const statusBadge: Record<string, string> = {
  ...
  // WC-182 / D22: design-review gate (IssueWorkProductReviewState). `approved`
  // already maps green above; the rest read as: `needs_board_review` = "awaiting
  // the board" (amber, like pending_approval), `changes_requested` = red (action
  // needed), `none` = a quiet neutral "not submitted yet".
  needs_board_review: "bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300",
  changes_requested: "bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300",
