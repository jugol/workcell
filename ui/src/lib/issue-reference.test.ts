...
describe("issue-reference", () => {
  ...
  it("does not treat GitHub issue URLs as internal Workcell issue links", () => {
    expect(parseIssuePathIdFromPath("https://github.com/jugol/workcell/issues/1778")).toBeNull();
    expect(parseIssueReferenceFromHref("https://github.com/jugol/workcell/issues/1778")).toBeNull();
  });
