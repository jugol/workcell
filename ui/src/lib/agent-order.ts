...
export const AGENT_ORDER_UPDATED_EVENT = "workcell:agent-order-updated";
export const AGENT_SORT_MODE_UPDATED_EVENT = "workcell:agent-sort-mode-updated";
const AGENT_ORDER_STORAGE_PREFIX = "workcell.agentOrder";
const AGENT_SORT_MODE_STORAGE_PREFIX = "workcell.agentSortMode";
