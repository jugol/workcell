...
export const PROJECT_ORDER_UPDATED_EVENT = "workcell:project-order-updated";
export const PROJECT_SORT_MODE_UPDATED_EVENT = "workcell:project-sort-mode-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "workcell.projectOrder";
const PROJECT_SORT_MODE_STORAGE_PREFIX = "workcell.projectSortMode";
