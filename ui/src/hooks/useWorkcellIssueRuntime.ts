...
export interface WorkcellIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface WorkcellIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: WorkcellIssueRuntimeReassignment;
}

interface UseWorkcellIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: WorkcellIssueRuntimeSendOptions) => Promise<void>;
...
export function useWorkcellIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseWorkcellIssueRuntimeOptions) {
