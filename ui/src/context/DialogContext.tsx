...
interface NewIssueDefaults {
  ...
  title?: string;
  description?: string;
  // WC-185: pre-enable the "Pair" toggle so the issue is created as a pair
  // (two agents collaborate in rounds). Used by discoverability affordances
  // (e.g. the add-agent dialog) that route the user into pair setup.
  pairAtCreate?: boolean;
}
