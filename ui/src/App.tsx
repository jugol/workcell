...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="projects/:projectId/design" element={<ProjectDetail />} />
      ...
      <Route path="inbox/todo" element={<Inbox />} />
      ...
      <Route path="inbox/new" element={<Navigate to="/inbox/todo" replace />} />
