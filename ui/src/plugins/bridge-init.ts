 ...
 *
 * This is placed on `globalThis.__workcellPluginBridge__` and consumed by
...
declare global {
  ...
  var __workcellPluginBridge__: PluginBridgeRegistry | undefined;
}
...
function PluginSdkIssuesList({
  ...
  projectId = null,
  filters,
  viewStateKey = "workcell:plugin-issues-view",
  initialSearch,
  createIssueLabel,
 ...
 * on `globalThis.__workcellPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__workcellPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
