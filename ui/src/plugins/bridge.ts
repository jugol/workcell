 ...
 * `useHostContext` from `@workcell/plugin-sdk/ui`.  Those are type-only
 ...
 * registry on `globalThis.__workcellPluginBridge__`), context propagation
...
/**
 * Resolve a plugin-provided Workcell path to the active company scope.
 *
