...
const INSTANCE_SETTINGS_MEMORY_KEY = "workcell.lastInstanceSettingsPath";
      ...
      <div className={cn("min-h-0 flex-1", isMobile ? "w-full" : "flex overflow-hidden")}>
        ...
        <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "h-full flex-1")}>
          ...
          <div className={cn(isMobile ? "block" : "flex flex-1 min-h-0")}>
            ...
            >
              {/* Route-level error boundary: a single page crash degrades to a
                  graceful in-pane fallback instead of blanking the whole control
                  plane. Keyed on the pathname so navigating away auto-recovers,
                  keeping the sidebar/nav/breadcrumb alive throughout. */}
