import type { IssueRelatedWorkItem, IssueRelatedWorkSummary } from "@workcell/shared";
  ...
  return (
    <div className="space-y-3">
      <Section
        ...
        description={t("issueRelatedWorkPanel.references.description", { defaultValue: "Other tasks this issue currently points at in its title, description, comments, or documents." })}
        items={outbound}
        emptyLabel={t("issueRelatedWorkPanel.references.empty", { defaultValue: "This issue does not reference any other tasks yet." })}
      />
      <Section
        title={t("issueRelatedWorkPanel.referencedBy.title", { defaultValue: "Referenced by" })}
        description={t("issueRelatedWorkPanel.referencedBy.description", { defaultValue: "Other tasks that currently point at this issue." })}
        items={inbound}
        emptyLabel={t("issueRelatedWorkPanel.referencedBy.empty", { defaultValue: "No other tasks reference this issue yet." })}
      />
    </div>
  );
}
