...
import type { IssueBlockerAttention } from "@workcell/shared";
...
export function StatusIcon({ status, blockerAttention, onChange, className, showLabel, disabledStatuses, triggerTestId }: StatusIconProps) {
  ...
  const ariaLabel = status === "blocked" ? blockedAttentionLabel(blockerAttention) : statusLabel(status, t);
