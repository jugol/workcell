...
import { PROJECT_COLORS } from "@workcell/shared";
      ...
      >
            ...
            <div className="mb-1 flex items-center gap-1.5">
              ...
              <Tooltip delayDuration={300}>
                ...
                <TooltipContent side="top" className="max-w-[240px] text-xs">
                  {t("newProjectDialog.repoUrlHint", { defaultValue: "Link a GitHub repository so agents can clone, read, and push code for this project." })}
                </TooltipContent>
              </Tooltip>
            </div>
            <input
          ...
          <div>
            <div className="mb-1 flex items-center gap-1.5">
              ...
              <Tooltip delayDuration={300}>
                ...
                <TooltipContent side="top" className="max-w-[240px] text-xs">
                  {t("newProjectDialog.localFolderHint", { defaultValue: "Set an absolute path on this machine where local agents will read and write files for this project." })}
                </TooltipContent>
              </Tooltip>
            </div>
          ...
          <Popover open={goalOpen} onOpenChange={setGoalOpen}>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {selectedGoals.length > 0 ? t("newProjectDialog.addGoal", { defaultValue: "+ Goal" }) : t("newProjectDialog.goal", { defaultValue: "Goal" })}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border">
          {createProject.isError ? (
            <p className="text-xs text-destructive">{t("newProjectDialog.createFailed", { defaultValue: "Failed to create project." })}</p>
          ) : (
            <span />
          )}
          <Button
          ...
          >
            {createProject.isPending ? t("newProjectDialog.creating", { defaultValue: "Creating…" }) : t("newProjectDialog.createProject", { defaultValue: "Create project" })}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
