...
import type { DeploymentMode } from "@workcell/shared";
...
const DOCS_URL = "https://docs.workcell.ing/";
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button
            ...
            aria-label={t("accountMenu.openMenu", { defaultValue: "Open account menu" })}
          >
            <Avatar size="sm">
          ...
          <div className="-mt-8 px-4 pb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 pt-1">
                ...
                {version ? (
                  <p className="mt-1 text-xs text-muted-foreground">{t("accountMenu.version", { defaultValue: "Workcell v{{version}}", version })}</p>
                ) : null}
              </div>
            </div>
            ...
            <div className="mt-4 space-y-1">
              <MenuAction
                label={t("accountMenu.viewProfile.label", { defaultValue: "View profile" })}
                description={t("accountMenu.viewProfile.description", {
              ...
              />
              <MenuAction
                label={t("accountMenu.editProfile.label", { defaultValue: "Edit profile" })}
                description={t("accountMenu.editProfile.description", {
              ...
              />
              <MenuAction
                label={t("accountMenu.instanceSettings.label", { defaultValue: "Instance settings" })}
                description={t("accountMenu.instanceSettings.description", {
              ...
              />
              <MenuAction
                label={t("accountMenu.documentation.label", { defaultValue: "Documentation" })}
                description={t("accountMenu.documentation.description", {
                  defaultValue: "Open Workcell docs in a new tab.",
                })}
                icon={BookOpen}
                href={DOCS_URL}
                external
              ...
              <MenuAction
                label={
                  theme === "dark"
                    ? t("accountMenu.theme.toLight", { defaultValue: "Switch to light mode" })
                    : t("accountMenu.theme.toDark", { defaultValue: "Switch to dark mode" })
                }
                description={t("accountMenu.theme.description", {
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-sm font-medium text-foreground">
                      {signOutMutation.isPending
                        ? t("accountMenu.signOut.pending", { defaultValue: "Signing out..." })
                        : t("accountMenu.signOut.label", { defaultValue: "Sign out" })}
                    </span>
