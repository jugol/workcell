...
import type { Agent, ExecutionWorkspace, Project } from "@workcell/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/workcell/project-1",
      effectiveLocalFolder: "/tmp/workcell/project-1",
