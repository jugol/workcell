    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {t("pathInstructionsModal.descriptionBefore", { defaultValue: "Paste the absolute path (e.g." })}{" "}
            <code className="text-xs bg-muted px-1 py-0.5 rounded">/Users/you/project</code>
            {t("pathInstructionsModal.descriptionAfter", { defaultValue: ") into the input field." })}
          </DialogDescription>
        </DialogHeader>
