...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "Workcell" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "Workcell" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "Workcell" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "Workcell" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "Workcell" },
