...
describe("MarkdownBody", () => {
  ...
  it("opens GitHub links in a new tab", () => {
    const html = renderMarkdown("[pr](https://github.com/jugol/workcell/pull/4099)");
  ...
  it("prefixes GitHub markdown links with the GitHub icon glued to the first character", () => {
    const html = renderMarkdown("[https://github.com/jugol/workcell/pull/4099](https://github.com/jugol/workcell/pull/4099)");

    expect(html).toContain('<a href="https://github.com/jugol/workcell/pull/4099"');
    ...
    expect(html).toContain("ttps://github.com/jugol/workcell/pull/4099");
    expect(html).not.toContain("lucide-external-link");
  });

  it("prefixes GitHub autolinks with the GitHub icon", () => {
    const html = renderMarkdown("See https://github.com/jugol/workcell/issues/1778");

    expect(html).toContain('<a href="https://github.com/jugol/workcell/issues/1778"');
    expect(html).toContain('class="lucide lucide-github mr-1 inline h-3.5 w-3.5 align-[-0.125em]"');
  });
