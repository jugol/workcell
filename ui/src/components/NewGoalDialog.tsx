...
import { GOAL_STATUSES, GOAL_LEVELS } from "@workcell/shared";
...
const levelLabelDefaults: Record<string, string> = {
  company: "Company",
  team: "Team",
  agent: "Agent",
  task: "Task",
...
function levelLabel(t: TFunction, level: string): string {
  return t(`goals.levels.${level}`, { defaultValue: levelLabelDefaults[level] ?? level });
}
