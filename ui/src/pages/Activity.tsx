...
import type { ActivityEvent, Agent } from "@workcell/shared";
...
export function Activity() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={History} message={t("activity.selectCompany", { defaultValue: "Select a team to view activity." })} />;
  }
