...
describe("ImportFromVaultDialog", () => {
  ...
  it("blocks import when a review row collides with an existing Workcell secret", async () => {
    ...
    expect(document.body.textContent?.toLowerCase()).toContain("a workcell secret already uses this");
  ...
  it("renders sanitized preview provider errors without raw AWS exception text", async () => {
    const rawProviderMessage =
      "AccessDeniedException: User: arn:aws:sts::123456789012:assumed-role/prod/Workcell is not authorized";
