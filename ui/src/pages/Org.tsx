...
export function Org() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("org.breadcrumb", { defaultValue: "Org Chart" }) }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message={t("org.emptyNoCompany", { defaultValue: "Select a company to view org chart." })} />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message={t("org.emptyNoAgents", { defaultValue: "No agents in the organization. Create agents to build your org chart." })}
        />
      )}
