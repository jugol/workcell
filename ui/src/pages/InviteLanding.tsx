...
function AwaitingJoinApprovalPanel({
  ...
  const approverLabel = invitedByUserName ?? t("inviteLanding.awaiting.defaultApprover", { defaultValue: "A company admin" });
...
export function InviteLandingPage() {
  ...
  const companyDisplayName = companyName || t("inviteLanding.companyFallback", { defaultValue: "this Workcell company" });
  ...
  const joinButtonLabel = useMemo(() => {
    ...
    if (isCurrentMember) return t("inviteLanding.joinButton.openCompany", { defaultValue: "Open company" });
          ...
          <div className="mx-auto max-w-md rounded-lg border border-border bg-card p-6">
            <div className="flex items-center gap-3">
              <InviteCompanyLogo
                ...
                className="h-12 w-12 rounded-md border border-border"
              />
              <h1 className="text-lg font-semibold">{t("inviteLanding.joinedCompany.title", { defaultValue: "You joined the company" })}</h1>
            </div>
            <div className="mt-4">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)]">
          <section className={`${panelClassName} space-y-6`}>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-md border border-border p-3">
                <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">{t("inviteLanding.details.company", { defaultValue: "Company" })}</div>
              ...
              <div className="rounded-md border border-border p-3">
                ...
                <div className="mt-1 text-sm text-foreground">
                  {showsAgentForm
                    ...
                    : requestedHumanRole ?? t("inviteLanding.details.companyAccess", { defaultValue: "Company access" })}
                </div>
              </div>
              <div className="rounded-md border border-border p-3">
            ...
            {showsAgentForm ? (
              ...
              <div className="space-y-4">
                <div>
                  <h2 className="text-lg font-semibold">
                    {isCurrentMember
                      ? t("inviteLanding.accept.alreadyMemberTitle", { defaultValue: "Already in this company" })
                      : shouldAutoAcceptHumanInvite
                      ? t("inviteLanding.accept.completingTitle", { defaultValue: "Completing company access" })
                      : invite.inviteType === "bootstrap_ceo"
                        ? t("inviteLanding.accept.bootstrapTitle", { defaultValue: "Accept bootstrap invite" })
                        : t("inviteLanding.accept.companyTitle", { defaultValue: "Accept company invite" })}
                  </h2>
                  <p className="mt-1 text-sm text-muted-foreground">
                    {shouldAutoAcceptHumanInvite
