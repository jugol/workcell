...
export function ProfileSettings() {
  ...
  const uploadAvatarMutation = useMutation({
    mutationFn: async (file: File) => {
      if (!selectedCompanyId) {
        throw new Error(t("profileSettings.errorSelectCompany", { defaultValue: "Select a team before uploading a profile avatar." }));
      }
  ...
  const uploadHint = selectedCompany
    ...
    : t("profileSettings.uploadHintNoCompany", { defaultValue: "Select a team to upload an avatar into Workcell storage." });
