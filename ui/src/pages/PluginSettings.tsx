...
export function PluginSettings() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: selectedCompany?.name ?? t("pluginSettings.breadcrumb.company", { defaultValue: "Company" }), href: "/dashboard" },
            ...
            <section className="space-y-4">
              ...
              {hasCustomSettingsPage ? (
                ...
                <div className="rounded-md border border-border/60 bg-muted/20 px-4 py-3 text-sm">
                  <p className="font-medium text-foreground">{t("pluginSettings.environments.heading", { defaultValue: "Configure this plugin from Company Environments." })}</p>
                  ...
                  <div className="mt-3">
                    <Link to="/company/settings/environments">
                      <Button variant="outline" size="sm">{t("pluginSettings.environments.openButton", { defaultValue: "Open Company Environments" })}</Button>
                    </Link>
                  </div>
                </div>
              ) : !hasLocalFolders ? (
