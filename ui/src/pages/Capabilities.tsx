        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {t("capabilities.description", {
              defaultValue:
                "Registry of capabilities the company has installed and how they're assigned to agents. Approval workflow lands in a later slice; this page lets admins view and transition existing assignments.",
            })}
          </p>
        </div>
      </header>
        ...
        {capabilities.length === 0 ? (
          <p className="rounded-md border border-dashed border-border/60 p-4 text-sm text-muted-foreground">
            {t("capabilities.manifestEmpty", {
              defaultValue:
                "No capabilities registered for this company yet. Future slices add a Register form here.",
            })}
          </p>
        ) : (
        ...
        {assignments.length === 0 ? (
          <p className="rounded-md border border-dashed border-border/60 p-4 text-sm text-muted-foreground">
            {t("capabilities.assignmentsEmpty", {
              defaultValue:
                "No active assignments. Once capabilities are assigned to a scope (company-wide or per-agent), they show up here.",
            })}
          </p>
        ) : (
          <ul className="space-y-2">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="text-xs text-muted-foreground">
                      ...
                      {a.agentId
                        ...
                        : t("capabilities.scopeCompanyWide", { defaultValue: "company-wide" })}
                    </span>
