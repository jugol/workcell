...
export function OrgChart() {
  ...
  // per-node badge still surfaces it.
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t("orgChart.emptyNoCompany", { defaultValue: "Select a company to view the org chart." })} />;
  }
      ...
      <div className="mb-2 flex shrink-0 flex-wrap items-center justify-start gap-2">
        <Link to="/company/import">
          <Button variant="outline" size="sm">
            ...
            {t("orgChart.importCompany", { defaultValue: "Import company" })}
          </Button>
        </Link>
        <Link to="/company/export">
          <Button variant="outline" size="sm">
            <Download className="mr-1.5 h-3.5 w-3.5" />
            {t("orgChart.exportCompany", { defaultValue: "Export company" })}
          </Button>
        </Link>
      </div>
      <div
              ...
              >
                <div className="flex items-center px-4 py-3 gap-3">
                  ...
                  <div className="flex flex-col items-start min-w-0 flex-1">
                    ...
                    {/* WC-189: pair marker on the node naming the counterpart + issue. */}
