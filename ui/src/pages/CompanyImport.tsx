...
export function CompanyImport() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Download} message={t("companyImport.empty.selectCompany", { defaultValue: "Select a team to import into." })} />;
  }
  ...
  return (
    <div>
      ...
      <div className="border-b border-border px-5 py-5 space-y-4">
        ...
        <Field label={t("companyImport.target.label", { defaultValue: "Target" })} hint={t("companyImport.target.hint", { defaultValue: "Import into this team or create a new one." })}>
          <select
            className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
            value={targetMode}
            onChange={(e) => {
          ...
          >
            <option value="new">{t("companyImport.target.createNew", { defaultValue: "Create new team" })}</option>
            <option value="existing">
              {t("companyImport.target.existing", { defaultValue: "Existing team: {{name}}", name: selectedCompany?.name ?? "" })}
            </option>
          </select>
        </Field>
        ...
        {targetMode === "new" && (
          <Field
            label={t("companyImport.newCompanyName.label", { defaultValue: "New team name" })}
          ...
          >
            <input
              ...
              placeholder={t("companyImport.newCompanyName.placeholder", { defaultValue: "Imported Team" })}
            />
          </Field>
        )}
        ...
        <Field
          ...
          hint={t("companyImport.collision.hint", { defaultValue: "Board imports can rename, skip, or replace matching team content." })}
        >
          <select
            className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
