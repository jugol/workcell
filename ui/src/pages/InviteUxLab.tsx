...
const inviteRoleOptions = [
  {
    value: "viewer",
    label: "Viewer",
    description: "Can view team work and follow along.",
    gets: "View-only team membership.",
  },
  {
    value: "operator",
    label: "Operator",
  ...
  },
  {
    value: "owner",
    label: "Owner",
    description: "Full team access, including membership management.",
  ...
  return (
    <>
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">You&apos;ve been invited to join Workcell</p>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <MetaCard label="Team" value="Acme Robotics" />
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? "Start with a Workcell account. After that, you'll come right back here to accept the invite for Acme Robotics."
            : "Use the Workcell account that already matches this invite. If you do not have one yet, switch back to create account."}
        </p>
      </div>
      ...
      <p className="text-xs leading-5 text-zinc-500">
        {mode === "sign_up"
          ? "Already signed up before? Use the existing-account option instead so the invite lands on the right Workcell user."
...
function AcceptInvitePreview({
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-lg font-semibold text-zinc-100">Accept team invite</h3>
        <p className="mt-1 text-sm text-zinc-400">
          {autoAccept
        ...
        <div className="flex min-h-[420px] flex-col justify-center bg-background px-8 py-10">
          <div className="mx-auto w-full max-w-md">
            ...
            <h3 className="text-xl font-semibold">
              {mode === "sign_in" ? "Sign in to Workcell" : "Create your Workcell account"}
            </h3>
      ...
      <Card className="rounded-[28px] shadow-none">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3 rounded-2xl border border-border px-4 py-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  This URL includes the current Workcell domain returned by the server.
                </div>
              </div>
            ...
            >
              https://workcell.local/invite/new-token
            </button>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="rounded-2xl border border-border p-4">
              ...
              <div className="mt-2 text-sm text-muted-foreground">
                No invites have been created for this team yet.
              </div>
            </div>
    ...
    <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_320px]">
          <div className="p-6 sm:p-7">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
              This page collects the current invite landing, signup, approval-result, and team invite-management states in one place so styling changes can be reviewed without recreating each backend condition by hand.
            </p>
          ...
          <aside className="border-t border-border/60 bg-background/70 p-6 lg:border-l lg:border-t-0">
            ...
            <div className="space-y-3">
              {[
                ...
                "Team invite creation, copied-link, history, empty, and permission-error states",
              ].map((highlight) => (
                <div
                  key={highlight}
      ...
      >
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <StatusCard
            ...
            body="Shown after sign-in while the app verifies whether the current user already belongs to the invited team."
          />
          <StatusCard
          ...
          <StatusCard
            ...
            body="Acceptance stays disabled and the page redirects into the team once membership is confirmed."
          />
          <StatusCard
      ...
      >
        <div className="space-y-5">
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description="Create your Workcell account first. If you already have one, switch to sign in and continue the invite with the same email."
          ...
          <InviteLandingShell
            ...
            right={<AcceptInvitePreview error="This account already belongs to the team." isCurrentMember />}
          />
        </div>
      </LabSection>
      ...
      >
        <div className="grid gap-5 xl:grid-cols-3">
          ...
          <InviteResultPreview
            title="Request to join Acme Robotics"
            description="Ask them to visit Team Settings → Members to approve your request."
          />
        </div>
      </LabSection>
