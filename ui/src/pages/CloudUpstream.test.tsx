...
import type { CloudUpstreamRun, CloudUpstreamsState } from "@workcell/shared";
...
const mockCompanyState = vi.hoisted(() => ({
  selectedCompany: { id: "company-1", name: "Workcell", issuePrefix: "PAP" } as
...
describe("CloudUpstream", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.selectedCompany = { id: "company-1", name: "Workcell", issuePrefix: "PAP" };
  ...
  it("sends a company-prefixed redirectUri when starting Connect", async () => {
    ...
    const input = container.querySelector<HTMLInputElement>("input[aria-label='Workcell Cloud stack URL']");
  ...
  it("uses the URL pathname prefix when cleaning up the callback URL with no company context", async () => {
    ...
    mockCloudUpstreamsApi.finishConnect.mockResolvedValue({
      ...
      target: {
        stackId: "stack-1",
        stackSlug: "stack",
        stackDisplayName: "Workcell Cloud",
    ...
    window.localStorage.setItem("workcell-cloud-upstream-pending-connection", "pending-1");
    ...
    try {
      ...
      window.localStorage.removeItem("workcell-cloud-upstream-pending-connection");
    }
  });
    ...
    connections: [
      {
        id: "connection-1",
        companyId: "company-1",
        remoteUrl: "https://workcell.example/PAP",
        target: {
          stackId: "stack-1",
          stackSlug: "stack",
          stackDisplayName: "Workcell Cloud",
          companyId: "cloud-company-1",
          primaryHost: "workcell.example",
          origin: "https://workcell.example",
          product: "Workcell Cloud",
          schemaMajor: 1,
          maxChunkBytes: 1024,
        },
...
function buildRun(input: {
  ...
  return {
    ...
    targetUrl: "https://workcell.example",
    report: input.report ?? {},
    retryOfRunId: null,
    createdAt: "2026-05-18T18:00:00.000Z",
