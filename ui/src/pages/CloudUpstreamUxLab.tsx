      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Push {selectedCompanyName} into a Workcell Cloud stack. Automations stay paused until activation.
          </p>
        </div>
        ...
        <div className="rounded-md border border-border px-4 py-4">
          {connection ? (
            ...
            <div className="grid gap-3 md:grid-cols-[1fr_auto]">
              <Input
                defaultValue="https://workcell.workcell.app/PC521D/dashboard"
                placeholder="https://workcell.workcell.app/PC521D/dashboard"
                aria-label="Workcell Cloud stack URL"
                autoFocus
              />
              <Button disabled>
...
const STACK_TARGET = {
  ...
  stackSlug: "workcell-prod",
  stackDisplayName: "Workcell Prod",
  companyId: "co_4hT2yX",
  primaryHost: "workcell.workcell.app",
  origin: "https://workcell.workcell.app",
...
function connectedConnection(target = STACK_TARGET): CloudUpstreamConnection {
  return {
    id: "cu_conn_8d3f1b6a",
    companyId: "co_4hT2yX",
    remoteUrl: "https://workcell.workcell.app/PC521D/dashboard",
    target,
...
function runningRun(): CloudUpstreamRun {
  return {
    ...
    targetUrl: "https://workcell.workcell.app/PC521D/dashboard",
    report: {},
    retryOfRunId: null,
...
function buildFixture(state: FixtureStateKey): Fixture {
  switch (state) {
    case "settings-pane":
      return {
        selectedCompanyName: "Workcell · PC521D",
