...
vi.mock("@/context/CompanyContext", () => ({
  useCompany: () => ({
    ...
    selectedCompany: { id: "company-1", name: "Workcell" },
  }),
}));
...
describe("CompanyAccess", () => {
      ...
      members: [
        {
          ...
          user: {
            id: "user-1",
            email: "codexcoder@workcell.local",
            name: "Codex Coder",
            image: null,
          },
          grants: [],
    ...
    listJoinRequestsMock.mockResolvedValue([
      {
        ...
        requestEmailSnapshot: "board@workcell.local",
  ...
  it("keeps the page human-focused and hides advanced permission controls", async () => {
    ...
    expect(container.textContent).toContain("Manage the people who can work in Workcell");
    expect(container.textContent).toContain("Members can collaborate across the team by default");
    ...
    expect(document.body.textContent).toContain("Update team role and membership status");
