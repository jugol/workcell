...
export function Costs() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={DollarSign} message={t("costs.emptyNoCompany", { defaultValue: "Select a team to view costs." })} />;
  }
                  ...
                  return (
                    <section key={scopeType} className="space-y-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {scopeType === "company"
                            ? t("costs.budgets.scopeDescription.company", { defaultValue: "Team-wide monthly policy." })
                            : scopeType === "agent"
                ...
                {budgetPolicies.length === 0 ? (
                  <Card>
                    <CardContent className="px-5 py-8 text-sm text-muted-foreground">
                      {t("costs.budgets.noPolicies", { defaultValue: "No budget policies yet. Set agent and project budgets from their detail pages, or use the existing team monthly budget control." })}
                    </CardContent>
                  </Card>
                ) : null}
              </div>
