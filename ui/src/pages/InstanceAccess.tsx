...
export function InstanceAccess() {
  ...
  const updateCompanyAccessMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("instanceAccess.toastCompanyAccessUpdated", { defaultValue: "Company access updated" }), tone: "success" });
    },
  });
    ...
    <div className="max-w-6xl space-y-6">
      <div className="space-y-3">
        ...
        <p className="max-w-3xl text-sm text-muted-foreground">
          {t("instanceAccess.subtitle", { defaultValue: "Search users, manage instance-admin status, and control which companies they can access." })}
        </p>
      </div>
            ...
            {(usersQuery.data ?? []).map((user) => (
              ...
              >
                ...
                <div className="mt-2 text-xs text-muted-foreground">
                  {t("instanceAccess.activeMembershipsCount", { defaultValue: "{{count}} active company memberships", count: user.activeCompanyMembershipCount })}
                </div>
              </button>
            ))}
          </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t("instanceAccess.companyAccessDescription", { defaultValue: "Toggle company membership for this user. New access defaults to an active operator membership." })}
                  </p>
                </div>
                ...
                <div className="flex justify-end">
                  ...
                  >
                    {updateCompanyAccessMutation.isPending ? t("instanceAccess.saving", { defaultValue: "Saving…" }) : t("instanceAccess.saveCompanyAccess", { defaultValue: "Save company access" })}
                  </Button>
                </div>
              </div>
