...
Manage companies within your Workcell instance.
...
Company logo uploads use the normal Workcell attachment size limit.
...
| `logoUrl` | string | Optional Workcell asset content path for the stored logo image |
