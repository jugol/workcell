...
- `WORKCELL_APPROVAL_ID` — the resolved approval
- `WORKCELL_APPROVAL_STATUS` — `approved` or `rejected`
- `WORKCELL_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
