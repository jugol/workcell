...
- **반영처:** `PRODUCT_SPEC.md` 「프로젝트 계획 문서 방법론」(canonical) · `docs/plan/PLAN.md §4.5`.
...
- **반영처:** `PRODUCT_SPEC.md` 「프로젝트 지식 그래프」 + `docs/plan/PLAN.md §4.6` + `ROADMAP.md` P3.
...
- **시퀀싱:** P2(Design Dashboard 기본 + UX agent) → P3(OD 브리지 + outbound MCP + capability registry). **반영처:** `PRODUCT_SPEC.md`「Open Design 통합」 + `PLAN.md §4.7` + `ROADMAP.md` P2/P3.
...
- **반영처:** `PRODUCT_SPEC.md`「구현 그라운딩」. 시퀀싱 영향 없음(P1 single-owner → P2 pair/Usage/Design → P3 graph/OpenDesign 유지).
...
- **반영처:** `PRODUCT_SPEC.md`「구현 그라운딩」. 시퀀싱: bootstrap+charter 기초=P1, registry/visibility+trust tier=P3.
...
- **반영처:** `PRODUCT_SPEC.md` 레퍼런스(승인 두 모드) + 「구현 그라운딩」 승인 bullet.
...
- **반영처:** `PRODUCT_SPEC.md`「범용 운영 모델」말미 Compound 문단 + 「에이전트 체계」기획자 role.
