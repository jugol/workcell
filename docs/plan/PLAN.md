...
> 1차 source of truth는 `../../PRODUCT_SPEC.md`(상세 기획서). 본 문서는 그 기획서를 구현용으로 정리한 **활성 계획**이다.
...
> 상세 source of truth = `../../PRODUCT_SPEC.md` 「프로젝트 계획 문서 방법론」.
...
> 상세 = `../../PRODUCT_SPEC.md` 「프로젝트 지식 그래프」. 결정 = `DECISIONS.md D12`.
...
> 상세 = `../../PRODUCT_SPEC.md` 「Open Design 통합」. 결정 = `DECISIONS.md D13`.
