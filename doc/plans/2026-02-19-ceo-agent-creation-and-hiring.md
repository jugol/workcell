...
- installed adapter list for this Workcell instance
...
## 8. New Skill: `workcell-create-agent`

Create new skill directory:

- `skills/workcell-create-agent/SKILL.md`
- `skills/workcell-create-agent/references/api-reference.md`
...
Also update `skills/workcell/SKILL.md` to reference this skill for hiring workflows.
...
- `workcell-create-agent` skill + docs updates
