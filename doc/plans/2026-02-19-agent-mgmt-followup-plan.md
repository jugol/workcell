...
- `skills/workcell/SKILL.md` and `skills/workcell/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/workcell-create-agent/SKILL.md`
