...
- create starter objects:
  ...
  - company goal
  - Orchestrator
  - a first functional-role agent (e.g. an engineer) for the capability the goal needs
...
- On dashboard: “Ask the Orchestrator for a plan” → creates a `strategy` issue/thread scoped to the company.
...
- Team of 3 can use one shared Workcell instance.
...
Workcell should manage the **issue → workspace → preview/PR → review handoff** lifecycle, but leave diffs/review/merge to external tools.
...
execution:
  ...
  preview:
    command: "pnpm dev --port $WORKCELL_PREVIEW_PORT"
    healthPath: "/"
    ttlMinutes: 120
  vcs:
    provider: github
...
- A chat plugin can converse without requiring chat to become the core Workcell product.
...
- **Keep** Workcell as the board-level control plane.
...
[1]: https://github.com/workcell/workcell "https://github.com/workcell/workcell"
[2]: https://github.com/workcell/workcell/blob/master/doc/SPEC-implementation.md "https://github.com/workcell/workcell/blob/master/doc/SPEC-implementation.md"
[3]: https://github.com/workcell/workcell/issues/704 "https://github.com/workcell/workcell/issues/704"
[4]: https://github.com/workcell/workcell/blob/master/docs/deploy/tailscale-private-access.md "https://github.com/workcell/workcell/blob/master/docs/deploy/tailscale-private-access.md"
[5]: https://github.com/workcell/workcell/blob/master/docs/deploy/deployment-modes.md "https://github.com/workcell/workcell/blob/master/docs/deploy/deployment-modes.md"
[6]: https://github.com/workcell/workcell/issues/692 "https://github.com/workcell/workcell/issues/692"
[7]: https://github.com/workcell/workcell/blob/master/doc/DEVELOPING.md "https://github.com/workcell/workcell/blob/master/doc/DEVELOPING.md"
[8]: https://github.com/workcell/workcell/blob/master/doc/PRODUCT.md "https://github.com/workcell/workcell/blob/master/doc/PRODUCT.md"
[9]: https://github.com/workcell/workcell/blob/master/docs/start/core-concepts.md "https://github.com/workcell/workcell/blob/master/docs/start/core-concepts.md"
