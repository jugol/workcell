...
This is intentionally separate from the normal Workcell dev image.
...
```sh
review-checkout-pr workcell/workcell 432
cd /work/checkouts/workcell-workcell/pr-432
```
...
## Preview the Workcell app from the PR
...
- Workcell's embedded PostgreSQL and local storage stay inside the container home volume via `WORKCELL_HOME=/home/reviewer/.workcell-review`.
