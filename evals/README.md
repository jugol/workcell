...
Eval framework for testing Workcell agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Workcell heartbeat skill:
